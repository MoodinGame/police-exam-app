...
export const eventTypeStyles = {
  ...
  study: { label: 'แผนอ่านของฉัน', dot: 'bg-violet-500', badge: 'bg-violet-100 text-violet-700' },
  practice: { label: 'แบบฝึกของฉัน', dot: 'bg-blue-500', badge: 'bg-blue-100 text-blue-700' },
};

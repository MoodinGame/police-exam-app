...
function AdminShell({ children, pathname }) {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fc]">
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#18284f]/95 shadow-lg shadow-slate-900/10 backdrop-blur-xl">
      ...
      <div className="mx-auto flex w-full max-w-app flex-col gap-5 px-4 py-5 sm:px-6 lg:flex-row lg:gap-7 lg:py-8">
        <aside className="shrink-0 lg:sticky lg:top-24 lg:h-[calc(100vh-7rem)] lg:w-64">
          <nav className="flex gap-2 overflow-x-auto rounded-3xl border border-white/10 bg-[#18284f] p-2 shadow-xl shadow-slate-900/15 lg:h-full lg:flex-col lg:overflow-y-auto lg:p-3" aria-label="เมนูผู้ดูแลระบบ">
    ...
    <>
      ...
      <div className="flex min-h-screen bg-[#f7f9fc]">
        ...
        <main className="app-main min-w-0 flex-1 p-4 pb-28 pt-[6.5rem] sm:p-6 sm:pb-28 sm:pt-[6.5rem] lg:p-8">
          ...
          <div className="relative z-10 mx-auto w-full max-w-app">
            <WorkspaceBar />
